...
describe("GeneralSettingsPanel", () => {
  ...
  // The tour replay row and its "Onboarding" group moved off this page onto
  // its own Settings ▸ Onboarding page, which lists every tour and lesson
  // with its own progress, rather than a single "replay" shortcut here.
  it("no longer carries the Onboarding group or the replay row", () => {
    renderPanel();
