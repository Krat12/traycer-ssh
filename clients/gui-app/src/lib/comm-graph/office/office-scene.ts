...
export class OfficeScene {
  ...
  sync(input: OfficeSceneInput): void {
    ...
    // AFTER the reception queue, and after the rehome above: both are what a
    // dispatch reads. A police car asks who just got a queue slot, and the
    // kerb wait asks who is still on their feet - which is only true of the
    // agents this sync has already set walking.
